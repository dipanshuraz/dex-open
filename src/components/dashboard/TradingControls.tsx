  ...
  return (
    <div className="flex flex-col px-4 py-4 font-sans text-sm">
      ...
      <div className="flex flex-col gap-1.5 mb-3">
         ...
         <div className="w-full h-11 bg-gray-50 dark:bg-[#100B1A] border border-black/10 dark:border-[#221A30] rounded flex items-center px-4 text-gray-400 dark:text-[#8C82A2] font-semibold text-sm">
            No selectable asset
         </div>
      </div>
      ...
      <div className="flex flex-col gap-1.5 mb-5">
         ...
         <div className="w-full h-11 bg-gray-50 dark:bg-[#100B1A] border border-black/10 dark:border-[#221A30] rounded flex items-center px-4 justify-between">
            <input type="text" placeholder="0" className="bg-transparent border-none outline-none text-black dark:text-white font-mono w-1/2" />
            <span className="text-gray-400 dark:text-gray-600 font-mono">≈ $NaN</span>
         </div>
      </div>

      {/* Toggles */}
      <div className="flex flex-col gap-3 mb-5 font-bold text-xs text-gray-500 dark:text-[#8C82A2]">
         <div className="flex justify-between items-center cursor-pointer group">
            <span className="group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">Take Profit - Stop Loss</span>
         ...
         <div className="flex justify-between items-center cursor-pointer group">
            <span className="group-hover:text-gray-700 dark:group-hover:text-gray-300 transition-colors">Fast Swaps Enabled</span>
      ...
      {/* Action Button */}
      <button className="w-full py-3.5 bg-[#4ADE80] hover:bg-[#3FD674] text-black font-extrabold tracking-wide rounded text-[13px] transition-colors mb-4">
         Deposit To Continue
      </button>

      {/* Presets */}
      <div className="grid grid-cols-3 gap-2">
         <button className="py-2.5 bg-gray-100 dark:bg-[#20153B] border border-black/5 dark:border-[#38275A] text-black dark:text-white font-extrabold uppercase text-[11px] rounded hover:bg-gray-200 dark:hover:bg-[#2A1D4E] transition-colors">
            Preset 1
         </button>
         <button className="py-2.5 bg-transparent border border-black/10 dark:border-[#221A30] text-gray-500 font-extrabold uppercase text-[11px] rounded hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
            Preset 2
         </button>
         <button className="py-2.5 bg-transparent border border-black/10 dark:border-[#221A30] text-gray-500 font-extrabold uppercase text-[11px] rounded hover:bg-black/5 dark:hover:bg-white/5 transition-colors">
            Preset 3
